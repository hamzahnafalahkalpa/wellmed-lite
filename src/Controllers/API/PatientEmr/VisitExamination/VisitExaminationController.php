...
namespace Projects\WellmedLite\Controllers\API\PatientEmr\VisitExamination;

use Projects\WellmedLite\Requests\API\PatientEmr\VisitExamination\{
    ViewRequest, ShowRequest, StoreRequest, DeleteRequest
};
use Illuminate\Support\Facades\Hash;
use Projects\WellmedLite\Jobs\LIS\RequestLabToLISJob;
use Projects\WellmedLite\Jobs\SatuSehat\ObservationJob;
use Projects\WellmedLite\Jobs\SatuSehat\SendSatuSehatJob;
