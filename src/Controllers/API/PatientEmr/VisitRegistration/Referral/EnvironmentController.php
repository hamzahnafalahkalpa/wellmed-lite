...
namespace Projects\WellmedLite\Controllers\API\PatientEmr\VisitRegistration\Referral;

use Projects\WellmedLite\Controllers\API\PatientEmr\Referral\EnvironmentController as EnvEnvironmentController;
