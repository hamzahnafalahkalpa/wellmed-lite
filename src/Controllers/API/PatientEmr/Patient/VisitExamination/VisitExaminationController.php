...
namespace Projects\WellmedLite\Controllers\API\PatientEmr\Patient\VisitExamination;

use Projects\WellmedLite\Requests\API\PatientEmr\Patient\VisitExamination\{
    StoreRequest
};
