...
class MigrateCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'wellmed-lite:migrate {--seed}';
     ...
     * @var string
     */
    protected $description = 'Run migrations for the WellmedLite project';
    ...
    public function handle()
    {
        ...
        $this->info("Migrations for WellmedLite project have been successfully executed.");

        if ($this->option('seed')){
            $this->info("Run seeding");
            Artisan::call('wellmed-lite:seed');
            $this->info("Seeded");
        }
        return Command::SUCCESS;
    }
